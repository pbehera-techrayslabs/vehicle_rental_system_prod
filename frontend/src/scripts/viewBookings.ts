...
<td class="p-3 text-center">${b.date}</td>
<td class="p-3 text-center">
${getStatusBadge(b.status)}
</td>
<td class="p-3 text-center space-x-2">
${b.status === "Pending" ? `
<button class="approve-btn bg-green-600 text-white px-3 py-1 rounded"
data-id="${b.id}">
Approve
</button>
` : ""}
${b.status === "Booked" ? `
<button class="cancel-btn bg-red-500 text-white px-3 py-1 rounded"
data-id="${b.id}">
Cancel
</button>
` : ""}
${b.status === "Cancelled" ? `
<button class="book-btn bg-blue-600 text-white px-3 py-1 rounded"
data-id="${b.id}">
Book Again
</button>
` : ""}
